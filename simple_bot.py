# в коментарях необхідно пояснювати призначення змінних, функцій і хід роботи
def welcome():
    '''призначення та принцип роботи функцій можна пояснювати за допомогою рядків документації'''
